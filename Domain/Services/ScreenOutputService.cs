...
namespace Test_Taste_Console_Application.Domain.Services
{
    ...
    public class ScreenOutputService : IOutputService
    {
        ...
        {
            ConsoleWriter.CreateTitle("Give us your 2 mins! We're loading Planets and their moons!", new[] { 100 });
            ConsoleWriter.CreateEmptyLines(1);
            ...
            ConsoleWriter.CreateTitle("Thanks for the time! here are Planets and their moons!", new[] { 100 });
            ConsoleWriter.CreateEmptyLines(1);

            ConsoleWriter.CreateTitle("See you... Bye Bye!", new[] { 100 });
        }

        public void OutputAllMoonsAndTheirMassToConsole()
        {
            ConsoleWriter.CreateTitle("Relax! All moons will be there on your Console..!", new[] { 100 });
            ConsoleWriter.CreateEmptyLines(1);
            ...
            ConsoleWriter.CreateTitle("Hola! All moons are here", new[] { 100 });
            ConsoleWriter.CreateEmptyLines(1);
        }

        public void OutputAllPlanetsAndTheirAverageMoonGravityToConsole()
        {
            ConsoleWriter.CreateTitle("Hold Tight! Planet Data and Avg. Moon Gravity is Loading..!", new[] { 80 });
            ConsoleWriter.CreateEmptyLines(1);
            ...
            ConsoleWriter.CreateTitle("Your Planet Data and Avg. Moon Gravity is Loaded", new[] { 80 });
            ConsoleWriter.CreateEmptyLines(2);
